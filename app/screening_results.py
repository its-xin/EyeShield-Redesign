...
try:
    from .screening_styles import DR_COLORS, DR_RECOMMENDATIONS, PROGRESSBAR_STYLE, SYSTEM_UNCERTAIN_LABEL
...
class ResultsWindow(QWidget):
    def __init__(self, parent=None):
        ...
        documentation_layout.setContentsMargins(12, 10, 12, 10)
        documentation_layout.setSpacing(6)
        ...
        reco_card.setMinimumHeight(140)
        ...
        explanation_group.setMinimumHeight(140)
    ...
    def generate_report(self):
        ...
        # Call unified generator (lazy import — reports.py is large)
        try:
